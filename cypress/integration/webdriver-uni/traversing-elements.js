...
describe("Traversing DOM elements in Cypress", () => {
  ...
  it("nextUntil() to get all of the next sibling DOM elements within elements until another element", () => {
    ...
    cy.get("#coffee").nextUntil("#espresso").should("contain", "Tea", "Milk")
  });

  it("not() to remove DOM element(s) from the set of elements", () => {
    cy.get(".traversal-button-states>button").not(".disabled").should("not.contain", "Warning")
  });
  ...
  it("prevAll() to get all previous sibling DOM elements within elements", () => {
    cy.get(".sales").prevAll().should("contain", "Finance")
  });
  ...
  it("siblings() To get all sibling DOM elements of elements", () => {
    ...
    cy.get(".traversal-button-other-states .active").siblings().each(($el, index, $list) => {
      const text = $el.text();
      cy.log(text);
    })
  });
